...
{
    /// <summary>
    /// Handles sending emails specific to the Racoms server
    /// </summary>
    public static class RacomsEmailSender
    {
        /// <summary>
        ...
        public static async Task<SendEmailResponse> SendUserVerificationEmailAsync(string displayName, string email, string verificationUrl)
        {
            ...
            {
                IsHTML = true,
                FromEmail = Configuration["RacomsSettings:SendEmailFromEmail"],
                FromName = Configuration["RacomsSettings:SendEmailFromName"],
                ToEmail = email,
                ToName = displayName,
                Subject = "Verify Your Email - Racoms"
            },
            "Verify Email",
