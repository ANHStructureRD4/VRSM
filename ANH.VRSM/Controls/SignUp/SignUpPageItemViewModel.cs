...
namespace ANH.VRSM
{
    ...
    /// </summary>
    public class SignUpPageItemViewModel : BaseViewModel
    {
        ...
        /// Default constructor
        /// </summary>
        public SignUpPageItemViewModel()
        {
            // Create commands
        ...
        /// </summary>
        /// <returns></returns>
        private async Task UpdateValuesFromLocalStoreAsync(ISignUpPageDataStore signUpPageDataStore)
        {
            // Get the stored credentials
            var storedBaseList = await signUpPageDataStore.GetCompositeListsAsync();
